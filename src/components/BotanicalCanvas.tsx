...
const PLANT_SKETCH_MAP: Record<string, string> = {
  "Rafflesia":       "/flora/sketch/sketch_rafflesia.webp",
  "Kantong Semar":   "/flora/sketch/full_screen_scientific_botanical_illustration_of_tropical_pitcher_plant_kantong.webp",
  "Melati":          "/flora/sketch/full_screen_scientific_botanical_illustration_of_jasmine_flowers_melati._style.webp",
  "Kenanga":         "/flora/sketch/full_screen_scientific_botanical_illustration_of_ylang_ylang_kenanga._style.webp",
  "Bunga Bangkai":   "/flora/sketch/sketch_bunga_bangkai_botanical_illustration.webp",
  "Teratai":         "/flora/sketch/sketch_teratai_botanical_illustration.webp",
  "Rotan":           "/flora/sketch/sketch_rotan_botanical_illustration.webp",
  "Kayu Putih":      "/flora/sketch/sketch_kayu_putih.webp",
  "Bambu":           "/flora/sketch/full_screen_scientific_botanical_illustration_of_bamboo_stalks_bambu._style.webp",
  "Mangrove":        "/flora/sketch/full_screen_scientific_botanical_illustration_of_mangrove_bakau._style_hand.webp",
  "Jati":            "/flora/sketch/sketch_jati_botanical_illustration.webp",
  "Cempaka":         "/flora/sketch/sketch_cempaka_botanical_illustration.webp",
  "Karet":           "/flora/sketch/sketch_karet_botanical_illustration.webp",
  "Durian":          "/flora/sketch/sketch_durian_botanical_illustration.webp",
  "Anggrek Bulan":   "/flora/sketch/sketch_anggrek_bulan.webp",
  "Cendana":         "/flora/sketch/sketch_cempaka_botanical_illustration.webp",
  "Kayu Cendana":    "/flora/sketch/sketch_cempaka_botanical_illustration.webp",
  "Pohon Damar":     "/flora/sketch/sketch_karet_botanical_illustration.webp",
  "Damar":           "/flora/sketch/sketch_karet_botanical_illustration.webp",
  "Pohon Ulin":      "/flora/sketch/sketch_jati_botanical_illustration.webp",
  "Ulin":            "/flora/sketch/sketch_jati_botanical_illustration.webp",
};

// ─── Mapping nama tumbuhan → file ikon pixel art di /public/flora/icon/ ──────
const PLANT_ICON_MAP: Record<string, string> = {
  "Rafflesia":       "/flora/icon/icon_rafflesia.webp",
  "Kantong Semar":   "/flora/icon/icon_kantong_semar.webp",
  "Melati":          "/flora/icon/icon_melati.webp",
  "Kenanga":         "/flora/icon/icon_kenanga.webp",
  "Bunga Bangkai":   "/flora/icon/icon_bunga_bangkai.webp",
  "Teratai":         "/flora/icon/icon_bunga_teratai.webp",
  "Rotan":           "/flora/icon/icon_rotan.webp",
  "Kayu Putih":      "/flora/icon/icon_kayu_putih.webp",
  "Bambu":           "/flora/icon/icon_bambu.webp",
  "Mangrove":        "/flora/icon/icon_mangrove.webp",
  "Jati":            "/flora/icon/icon_pohon_jati.webp",
  "Cempaka":         "/flora/icon/icon_bunga_cempaka.webp",
  "Karet":           "/flora/icon/icon_pohon_karet.webp",
  "Durian":          "/flora/icon/icon_buah_durian.webp",
  "Anggrek Bulan":   "/flora/icon/icon_anggrek_bulan.webp",
  "Cendana":         "/flora/icon/icon_bunga_cempaka.webp",
  "Pohon Damar":     "/flora/icon/icon_pohon_karet.webp",
  "Pohon Ulin":      "/flora/icon/icon_pohon_jati.webp",
};

import { getNormalizedPlantKey, formatPlantName } from "@/lib/plantUtils";
export { getNormalizedPlantKey, formatPlantName };
